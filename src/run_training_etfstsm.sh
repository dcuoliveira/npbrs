...
python -m gym.training_etfstsm --utility AvgDD --functional means --alpha 0.05 --k 100
python -m gym.training_etfstsm --utility MaxDD --functional means --alpha 0.05 --k 100
python -m gym.training_etfstsm --utility "% Positive Ret." --functional means --alpha 0.05 --k 100
