...
python -m gym.training_etfstsm --utility MaxDD --functional means --alpha 0.50 --k 100 --end_date "2015-12-31"
python -m gym.training_etfstsm --utility MaxDD --functional means --alpha 0.25 --k 100 --end_date "2015-12-31"
